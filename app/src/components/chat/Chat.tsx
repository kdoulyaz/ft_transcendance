...
// import { UserStatus } from '../../components/picture';
...
//             if (id) {
//                 try {
//                     const res = await instance.get(`/chat/dm/${id}`);
//                     updateState({
...
//         };
//     }, [socket, id, pushMessage, pushRoom, updateState]);
